...
export interface DietPlanRow {
    ...
    exchanges: {
        ...
        milkFull: number; // Mapped from milk_high_whole
        meatLow: number;  // Mapped from meat_lean_low
...
export const mapDBRowToTemplate = (row: any): DietPlanRow => ({
    ...
    exchanges: {
        ...
        milkFull: Number(row.milk_high_whole || 0),
        meatLow: Number(row.meat_lean_low || 0),
        ...
        distributions: [
            {
                ...
                rows: [
                    { kcal: 1200, exchanges: { starch: 4, veg: 6, fruit: 2, legumes: 1, milkSkim: 0, milkLow: 1, milkFull: 0, meatLow: 1, meatMed: 2, meatHigh: 0, fatsSat: 0, fatsMufa: 3, fatsPufa: 1.5, sugar: 0 } },
                    { kcal: 2000, exchanges: { starch: 6, veg: 6, fruit: 4, legumes: 2, milkSkim: 0, milkLow: 1, milkFull: 1, meatLow: 3, meatMed: 3, meatHigh: 0, fatsSat: 0, fatsMufa: 3, fatsPufa: 2, sugar: 1 } }
                ]
            }
        ]
    }
